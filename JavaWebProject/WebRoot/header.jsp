        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>UserInfo/frontlist">学员</a></li>
                <li><a href="<%=basePath %>Jiaofei/frontlist">缴费</a></li>
                <li><a href="<%=basePath %>JiaofeiType/frontlist">缴费类型</a></li>
                <li><a href="<%=basePath %>Coach/frontlist">教练</a></li>
                <li><a href="<%=basePath %>Exam/frontlist">考试</a></li>
