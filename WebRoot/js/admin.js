		       ...
		       text: "缴费管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Jiaofei/jiaofei_add.jsp"
			    	   	},
			    		{
			    	   		text: "缴费管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Jiaofei/jiaofei_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "缴费类型管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "JiaofeiType/jiaofeiType_add.jsp"
			    	   	},
			    		{
			    	   		text: "缴费类型管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "JiaofeiType/jiaofeiType_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "教练管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Coach/coach_add.jsp"
			    	   	},
			    		{
			    	   		text: "教练管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Coach/coach_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "考试管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Exam/exam_add.jsp"
			    	   	},
			    		{
			    	   		text: "考试管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Exam/exam_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "留言管理",
